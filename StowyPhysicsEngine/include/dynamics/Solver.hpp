...
public:
    ...
    virtual void WarmingStartingSolve(std::vector<Collision>& collisions, float deltaTime) {};
};
...
public:
    ...
    void WarmingStartingSolve(std::vector<Collision>& collisions, float deltaTime);
};
