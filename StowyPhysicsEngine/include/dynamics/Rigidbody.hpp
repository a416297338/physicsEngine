...
struct Rigidbody : CollisionBody
{
    ...
    Vector2 GetCenter();
    inline float AngularVelocity() { return _angular_velocity;}
    inline void SetAngularVelocity(float angular) { _angular_velocity = angular; }
    void UpdateImpulse(const Vector2& impulse,const float& angular_impulse);
